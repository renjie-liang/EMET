...
class MultiTeacherPlus:
    ...
    def _build_model(self, word_vectors):
        ...
        softloss_label = self.configs.loss.t0_cof * kdloss_t0 \
        ...
        softloss_inter = self.configs.loss.inter_cof_0 * inter_loss_0 + self.configs.loss.inter_cof_1 * inter_loss_1


        ## total loss
        self.loss = hardloss_s + hardloss_t0 + softloss_label + softloss_inter
